...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{fig/michelson_konz_schirm.jpg}
    ...
    \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{fig/michelson_konz_tuer.jpg}
...
\begin{figure}[H]
    \centering
    \begin{samepage}
        \includegraphics[width=0.7\linewidth]{fig/Zerstreuungslinse.jpg}
...
%!TODO des da noch gescheit beschreiben.  
\setcapindent{0pt}
\begin{figure}[H]
    \centering
    \begin{minipage}[t]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{fig/Out_horizontal_detail.jpg} %! I glaub da hab ma kein Bild einfach irdendwas genommen :) was gleich ausschaut
