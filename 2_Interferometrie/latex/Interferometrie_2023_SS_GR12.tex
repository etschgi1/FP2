...
%     \centering
%     \begin{samepage}
%         \includegraphics[width=0.7\linewidth]{figures/Aufbau_eine_ohmsche_last.jpg}
%         \caption{Aufbau Leistungsmessung an einer ohmschen Last}
%         \label{fig:aufbau_eine_ohmsche_last}
%     \end{samepage}
% \end{figure}
