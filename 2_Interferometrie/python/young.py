...
def main() -> None:
    ...
    if CALC_DOUBLE_SLITS:
        ...
        for i, (slit, data_ruler, data_imagej, converter) in enumerate(
            ...
            ax.plot(data_imagej["m"] * 100, data_imagej["I"], label="Messdaten")

            # plot ruler data
            for point in data_ruler:
                point *= 100  # convert to cm
            ...
            lt.plt_uplot(data_imagej["m"] * 100, total, label="Theoretischer Verlauf")
    ...
    ax.plot(grating_data_imagej["m"] * 100, grating_data_imagej["I"], label="Messdaten")
