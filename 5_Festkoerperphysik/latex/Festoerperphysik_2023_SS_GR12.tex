...
%
% info unsischerheiten hier einfach angenommen :)) idk if better this way 0,01 mA is doch a bissl wenig sonst
\begin{table}[H]
    \centering
    \begin{samepage}
...
% info hier auf die gleichen Unsicherheiten wie oben :)
\begin{table}[H]
    \centering
    \begin{samepage}
